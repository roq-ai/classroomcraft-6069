  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'learning_module.count', 'lesson_plan.count', 'proposal.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('learning_module', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          accessorKey: 'learning_module',
          cell: ({ row: { original: record } }: any) => record?._count?.learning_module,
        }
      : null,
    hasAccess('lesson_plan', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'lesson_plan',
          header: 'Lesson Plan',
          accessorKey: 'lesson_plan',
          cell: ({ row: { original: record } }: any) => record?._count?.lesson_plan,
        }
      : null,
