...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`ClassroomCraft`}</title>

        <meta
          name="description"
          content="ClassroomCraft: Bridging the gap between institutions and educators, transforming digital education with personalized, high-quality content tailored to your specific needs."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`ClassroomCraft: Bridging the gap between institutions and educators, transforming digital education with personalized, high-quality content tailored to your specific needs.`}
            </Text>
            <Box
